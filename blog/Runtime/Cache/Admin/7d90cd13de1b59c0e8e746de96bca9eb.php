...
<!--[if lt IE 9]>
<script type="text/javascript" src="<?php echo ($smarty["const"]["ADMIN_LIB_URL"]); ?>/html5.js"></script>
<script type="text/javascript" src="<?php echo ($smarty["const"]["ADMIN_LIB_URL"]); ?>/respond.min.js"></script>
<script type="text/javascript" src="<?php echo ($smarty["const"]["ADMIN_LIB_URL"]); ?>/PIE_IE678.js"></script>
<![endif]-->
<link rel="stylesheet" type="text/css" href="<?php echo ($smarty["const"]["ADMIN_STATIC_URL"]); ?>/h-ui/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css" href="<?php echo ($smarty["const"]["ADMIN_STATIC_URL"]); ?>/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css" href="<?php echo ($smarty["const"]["ADMIN_LIB_URL"]); ?>/Hui-iconfont/1.0.7/iconfont.css" />
<link rel="stylesheet" type="text/css" href="<?php echo ($smarty["const"]["ADMIN_LIB_URL"]); ?>/icheck/icheck.css" />
<link rel="stylesheet" type="text/css" href="<?php echo ($smarty["const"]["ADMIN_STATIC_URL"]); ?>/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="<?php echo ($smarty["const"]["ADMIN_STATIC_URL"]); ?>/h-ui.admin/css/style.css" />
<!--[if IE 6]>
<script type="text/javascript" src="http://<?php echo ($smarty["const"]["ADMIN_LIB_URL"]); ?>.h-ui.net/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<script type="text/javascript" src="<?php echo ($smarty["const"]["ADMIN_LIB_URL"]); ?>/jquery/1.9.1/jquery.min.js"></script> 
<script type="text/javascript" src="<?php echo ($smarty["const"]["ADMIN_LIB_URL"]); ?>/layer/2.1/layer.js"></script> 
<script type="text/javascript" src="<?php echo ($smarty["const"]["ADMIN_STATIC_URL"]); ?>/h-ui/js/H-ui.js"></script> 
<script type="text/javascript" src="<?php echo ($smarty["const"]["ADMIN_STATIC_URL"]); ?>/h-ui.admin/js/H-ui.admin.js"></script> 
