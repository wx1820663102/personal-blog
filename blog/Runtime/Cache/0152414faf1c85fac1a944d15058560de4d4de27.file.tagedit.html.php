<?php /* Smarty version Smarty-3.1.6, created on 2016-08-05 08:35:38
         compiled from "D:/php/WWW/chuanzhi/tpblog/blog/Admin/View\Tag\tagedit.html" */ ?>
<?php /*%%SmartyHeaderCode:1215957a291af13dbf0-48059432%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0152414faf1c85fac1a944d15058560de4d4de27' => 
    array (
      0 => 'D:/php/WWW/chuanzhi/tpblog/blog/Admin/View\\Tag\\tagedit.html',
      1 => 1470357334,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1215957a291af13dbf0-48059432',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57a291af22053',
  'variables' => 
  array (
    'info' => 0,
    'catelist' => 0,
...
<?php if ($_valid && !is_callable('content_57a291af22053')) {function content_57a291af22053($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
" method="post" class="form form-horizontal" id="form-user-add">
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['info']->value['tagname'];?>
" placeholder="" id="user-name" name="tagname">
        <input type="hidden" name="tag_id" value="<?php echo $_smarty_tpl->tpl_vars['info']->value['tag_id'];?>
">
      </div>
      <div class="col-5"> </div>
    </div>
...
" <?php if ($_smarty_tpl->tpl_vars['info']->value['category_id']==$_smarty_tpl->tpl_vars['v']->value['category_id']){?>selected='selected'<?php }?>>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <textarea name="describe" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,100)"><?php echo $_smarty_tpl->tpl_vars['info']->value['describe'];?>
</textarea>
